...
typedef pair<vector<kmer_int_type_t>, unsigned int> extension;
...
typedef __gnu_cxx::hash_map<kmer_int_type_t, extension,hashme,eqstr> extension_map;
...
public:
    ...
    bool set_forward(kmer_int_type_t kmer_val);
    bool set_reverse(kmer_int_type_t kmer_val);
    bool set_seed(kmer_int_type_t kmer_val);
